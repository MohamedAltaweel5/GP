...
<head>
  ...
  <title>Post Graduate Sys | User Profile</title>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">              
              <li class="active"><a href="#settings" data-toggle="tab">Dr Profile</a></li>
            </ul>
              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputName" placeholder="Username" value="mohamed gad">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" placeholder="Full Name" value="mohamed A. Gad">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group" style="padding-right: 30px;">
                        <label for="exampleInputFile">Edit Pic</label>
