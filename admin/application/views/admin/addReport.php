...
<head>
  ...
  <title>Post Graduate Sys | Add Report</title>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">              
              <li class="active"><a href="#add" data-toggle="tab">Add Report</a></li>
            </ul>
              ...
              <div class="active tab-pane" id="add">
                <form class="" method="post" action="" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="report_title" required="required" placeholder="Enter ..." type="text">
                    </div>                                                                                                
