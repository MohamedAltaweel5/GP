...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $adminProfile[0]['admin_username'] ?> Profile
      </h1>
      <ol class="breadcrumb">
          <li><a href="<?php echo base_url(); ?>admin/main/index"><i class="fa fa-dashboard"></i> Home</a></li>        
        <li class="active"><?php echo $adminProfile[0]['admin_username'] ?> Profile</li>
      </ol>
    </section>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">              
              <li class="active"><a href="#settings" data-toggle="tab"><?php echo $adminProfile[0]['admin_username'] ?> Profile</a></li>
            </ul>
              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal" method="post" >
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputName" name="admin_username" placeholder="Username" value="<?php echo $adminProfile[0]['admin_username']; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control" id="inputName" name="admin_password" placeholder="Password" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputName" placeholder="Email" name="admin_email" value="<?php echo $adminProfile[0]['admin_email']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputExperience" class="col-sm-2 control-label">Phone</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="admin_phone" placeholder="phone" value="<?php echo $adminProfile[0]['admin_phone']; ?>">
                    </div>
                  </div>                                     
                  <div class="form-group">
