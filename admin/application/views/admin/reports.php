            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr> 
                    ...
                    <td><?php echo $report['student_fullname']; ?></td>                                                               
                    <td><a href="<?php echo base_url(); ?>admin/students/addDoctorReport/<?php echo $report['report_id'] ?>" class="btn btn-primary">add doctor</a> </td>
                </tr>  
                   <?php } ?>
