...
<head>
  ...
  <title>Post Graduate Sys | Add Students</title>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">              
              <li class="active"><a href="#add" data-toggle="tab">Add Students</a></li>
            </ul>
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="add">
                <form class=""method="post" enctype="multipart/form-data">                  
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile" class="col-sm-2 control-label">Upload Excel(CSV) Sheet</label>
                        <input type="file" name="studentsheet" multiple="" id="exampleInputFile">                                                
                    </div>
