      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
                <a href="" class="btn btn-primary" style="float:right;">add doctor</a>
                <br/>
                <br/>
                <br/>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr> 
                    ...
                    <td>mohamed</td> 
                    <td><a  class="btn btn-danger">profile</a> <a  class="btn btn-danger">edit</a> <a class="btn btn-danger">delete</a> </td>
                </tr>  
                <tr> 
