...
<head>
  ...
  <title>Post Graduate Sys | Add Course</title>
              ...
              <div class="active tab-pane" id="add">
                <form class=""method="post" action="">                  
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="course_name" required="required" placeholder="Enter ..." type="text">
                    </div>
                    <div class="form-group">
                        <label>Course code</label>
                        <input class="form-control" name="course_code" required="required" placeholder="Enter ..." type="text">
                    </div>
                    <div class="form-group">
                        <label>Course Hours</label>
                        <input class="form-control" name="course_hours" required="required" placeholder="Enter ..." type="text">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="course_time" required="required" placeholder="Enter ..." type="text">
                    </div>
                    <div class="form-group">
                        <label>Course place</label>
                        <input class="form-control" name="course_place" required="required" placeholder="Enter ..." type="text">
                    </div>
